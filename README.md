...
2. Скачайте файл `GamesTrack-0.2.12.apk`.
...
Версия 0.2.8 впервые получила постоянную подпись GamesTrack. Если у вас установлена 0.2.7 или более ранняя тестовая APK, один раз удалите её перед установкой 0.2.12. Версии 0.2.8 и новее обновляются поверх без удаления приложения.
